...
class QuizApp:
    ...
    def _genera_prompt(self) -> str:
        ...
        return (
        "Se detectaron errores al factorizar diferencias de cuadrados.\n\n"
        "Para **cada error** escribe un bloque con este formato EXACTO (sin Markdown):\n\n"
        # ──────────────── nuevo formato ────────────────
        "Se tienen errores en la Pregunta X\n"
        "Respuesta dada: ...\n"
        ...
        "----  (deja una línea en blanco después de cada bloque)  ----\n\n"
        # ───────────────────────────────────────────────────────────
        f"{detalle}\n\n"
        "- Concluye con /no_think."
    )
